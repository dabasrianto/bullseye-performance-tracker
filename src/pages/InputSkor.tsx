  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="container mx-auto py-8 px-4">
        <h1 className="text-3xl font-bold text-center mb-8 text-archery-darkBlue flex items-center justify-center">
          ...
          <div className="bg-white p-6 rounded-lg shadow-md">
            <div className="flex justify-between items-center mb-6">
              ...
              <div className="flex gap-2">
                <Award className="h-5 w-5 text-archery-orange" />
                <span className="text-sm font-medium">World Archery Standard</span>
              </div>
            </div>
